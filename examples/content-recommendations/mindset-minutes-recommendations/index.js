/**
 * index.js
 * @file Frontend script for the get-mindset-minutes-content-recommendations example web page.
 * @description This script demonstrates how to use the `web-nestre-api` library 
 * to fetch mindset minutes content recommendations for a user.
...
//------------------------------------------------------------//
{
    ...
    try {
        Log(`Fetching mindset minutes recommendations for user: ${userId}...`);
        
        const recommendations = await NestreApiManager.GetInstance().contentRecommendationsApi.GetMindsetMinutesContentRecommendations(userId, numRecommendations);
